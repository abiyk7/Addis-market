...
export const metadata = {
  title: "Privacy Policy · የግላዊነት ፖሊሲ — Addis Market",
};
  ...
  return (
    <div className="min-h-screen py-10 px-4" style={{ background: "#FFFDF7" }}>
      <div className="max-w-2xl mx-auto rounded-2xl p-6 sm:p-8" style={{ background: COLORS.card, border: `1px solid ${COLORS.parchmentDark}` }}>
        <h1 className="text-2xl font-bold mb-1" style={{ color: COLORS.coffeeDark }}>Privacy Policy · የግላዊነት ፖሊሲ</h1>
        ...
        <div className="mt-8 text-center">
          <a href="/" className="text-sm font-semibold" style={{ color: COLORS.goldDark }}>← Back to home · ወደ መነሻ ገጽ ተመለስ</a>
        </div>
      </div>
    </div>
  );
