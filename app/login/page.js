        ...
        {!otpSent ? (
          ...
          <>
            <input
              ...
              style={{ border: `1px solid ${COLORS.parchmentDark}`, background: "#FBF8EF" }}
            />
            <button onClick={verifyCode} disabled={loading || code.length < 4} className="w-full py-2.5 rounded-full font-semibold text-sm disabled:opacity-50" style={{ background: COLORS.gold, color: COLORS.coffeeDark }}>
